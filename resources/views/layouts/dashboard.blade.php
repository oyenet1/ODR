...
<body class="app sidebar-mini rtl">
    <!-- Navbar-->
    <header class="app-header"><a class="app-header__logo" href="index.html">Laravel_8 Laratrust</a>
    ...
    <aside class="app-sidebar">
        <div class="app-sidebar__user"><img class="app-sidebar__user-avatar"
                src="https://s3.amazonaws.com/uifaces/faces/twitter/jsa/48.jpg" alt="{{ Auth::user()->name }}">
            <div>
                <p class="app-sidebar__user-name text-capitalize">{{ Auth::user()->name }}</p>
